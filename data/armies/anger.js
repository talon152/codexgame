export const angerArmy = {
  faction: {
    id: "anger",
    name: "Anger Legion",
    summary: "Explosive impulses that overwhelm obstacles through relentless strikes and burning resolve across the stormlit isles.",
  },
  roster: [
    {
      id: "emberlash-brutes",
      ...
      description:
        "Smoldering vanguards that sear aurora steppes for +2 ATK yet find their fury dampened by glimmer-fen doubt (-1 ATK).",
      detail:
      ...
      traits: [
        ...
        "Fuel for the Flame: Gain +2 ATK on aurora steppes but lose 1 ATK in glimmer fens where anger sputters.",
      ],
      terrainModifiers: {
        steppe: { attack: 2 },
        fen: { attack: -1 },
    ...
    },
    {
      ...
      role: "Shock cavalry",
      description:
        "Tempestuous chargers that add +2 ATK on aurora steppes but suffer -1 DEF in Lumin Groves where rage snags on calm memories.",
      detail:
      ...
      traits: [
        ...
        "Tunnel Vision: Lose 1 DEF in Lumin Groves where their fury struggles to navigate.",
      ],
      terrainModifiers: {
        steppe: { attack: 2 },
        grove: { defence: -1 },
    ...
    },
    {
      ...
      description:
        "Channelers who hurl molten invective, gaining +3 ATK on Celestial Spires as pressure vents through fault lines.",
      detail:
        "They weaponise focused outrage, translating suppressed grievances into incandescent bolts of pain.",
      traits: [
        "Fury Bolt: Base 7 ATK climbs to 10 ATK on Celestial Spire ridges.",
    ...
    },
    {
      ...
      description:
        "Towering embodiments of wrath that gain +2 STR battering Sky Sanctums but lose 1 INIT on Star Currents as anger cools.",
      detail:
        "Every step of these titans cracks the mindscape, hurling molten rubble toward anything that resists them.",
      traits: [
        "Inferno Hammer: Base 8 STR surges to 10 STR when demolishing sanctum settlements.",
        "Slow Burn: Initiative drops to 3 on Star Currents where their heat hisses away.",
      ],
      terrainModifiers: {
        sanctum: { strength: 2 },
    ...
    },
    {
      ...
      description:
        "Fury given form that gains +1 ATK/+1 INIT in Lumin Groves where grudges lie in wait.",
      detail:
      ...
      traits: [
        ...
        "Predatory Focus: Add +1 ATK and +1 INIT in Lumin Groves dense with unresolved confrontations.",
      ],
      terrainModifiers: {
        grove: { attack: 1, initiative: 1 },
      },
