export const fearArmy = {
  faction: {
    id: "fear",
    name: "Fear Dominion",
    summary: "Shadows of anxiety that manipulate perception, dragging foes into hesitation and doubt across the star-swept frontier.",
  },
  roster: [
    {
      id: "dread-sentries",
      ...
      description:
        "Nightmarish wardens who thrive in Lumin Groves, gaining +3 DEF as they twist radiant boughs into cages of apprehension.",
      detail:
        "They whisper half-remembered failures that paralyse attackers long enough for other nightmares to descend.",
      traits: [
        "Suffocating Presence: 6 DEF becomes 9 DEF among tangled groves where fear tightens.",
    ...
    },
    {
      ...
      description:
        "Spectral messengers who slip through glimmer fens, gaining +2 INIT/+1 ATK when fighting amid murky recollections.",
      detail:
        "They deliver jolts of panic before melting back into the mist, forcing armies to fight in fragmented formation.",
      traits: [
        "Unnerving Flurry: Flexible 6 ATK and 7 INIT jump to 7 ATK/9 INIT in glimmer fens.",
        "Fleeting Echo: After striking they can relocate one tile, leaving panic behind.",
      ],
      terrainModifiers: {
        fen: { attack: 1, initiative: 2 },
      },
    ...
    },
    {
      ...
      role: "Hexing casters",
      description:
        "Wielders of chilling illusions who gain +2 ATK and +1 STR on Star Currents, reflecting how dread floods the mind.",
      detail:
        "They conjure visions of worst-case futures, sapping resolve while reshaping terrain into traps.",
      traits: [
        "Flood of Dread: Base 6 STR/7 ATK become 7 STR/9 ATK on Star Currents.",
        "Piercing Whispers: Even if their attacks glance off, they inflict a temporary INIT penalty on enemies.",
      ],
      terrainModifiers: {
        current: { strength: 1, attack: 2 },
      },
    ...
    },
    {
      ...
      description:
        "Mounted dread that feeds on Celestial Spire echoes, gaining +2 INIT while descending but losing 1 ATK on bright aurora steppes.",
      detail:
        "They stampede down cliffs in clattering waves, sending shards of trepidation rippling through whole provinces.",
      traits: [
        "Avalanche Charge: Their 7 INIT spikes to 9 INIT on Celestial Spires to seize the first strike.",
        "Sunblind: Lose 1 ATK on aurora steppes saturated with optimism.",
      ],
      terrainModifiers: {
        spire: { initiative: 2 },
        steppe: { attack: -1 },
    ...
    },
    {
      ...
      description:
        "Colossal fears that root themselves in Sky Sanctums, gaining +2 DEF there while draining 1 INIT from adjacent foes.",
      detail:
        "They crystallise the terror of letting others down, locking settlements into spirals of apprehension until freed.",
      traits: [
        "Unshakable Paranoia: Base 7 DEF rises to 9 DEF amid sanctum plazas.",
