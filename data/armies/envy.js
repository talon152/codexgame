export const envyArmy = {
  faction: {
    id: "envy",
    name: "Envy Syndicate",
    summary: "Cunning manifestations of jealousy that siphon strength from rivals and weaponise comparison.",
  },
  roster: [
    {
      id: "covetous-raiders",
    ...
    },
    {
      ...
      description:
        "Sinuous duelists who gain +2 INIT on water by copying the fluid grace of admired foes.",
      detail:
        "They dance around opponents, reflecting every flourish back with a spiteful twist that undermines confidence.",
      traits: [
        "Envious Riposte: 7 INIT climbs to 9 INIT on water, letting them respond before rivals can bask in success.",
    ...
    },
    {
      ...
      description:
        "Long-range projections that gain +2 ATK on mountains as they hurl weaponised comparisons from lofty vantage points.",
      detail:
        "Each salvo is a litany of perceived slights, exploding into shrapnel that convinces targets they'll never measure up.",
      traits: [
        "Barbed Accusations: Baseline 7 ATK jumps to 9 ATK on mountain ridges.",
    ...
    },
    {
      ...
      description:
        "Predatory raiders who gain +1 STR/+1 ATK on water while draining 1 inspiration from captured tiles.",
      detail:
        "They surge through emotional tides, stealing credit and momentum to deny others the spotlight.",
      traits: [
        "Jealous Undertow: Base 6 STR/7 ATK rise to 7 STR/8 ATK on water.",
        "Credit Hoarders: Seize 1 inspiration from defeated foes if any remains.",
      ],
      terrainModifiers: {
        water: { strength: 1, attack: 1 },
      },
    ...
    },
    {
      ...
      description:
        "Towering monuments that project comparison auras, gaining +2 DEF in villages and converting excess inspiration into will.",
      detail:
        "They remind every inhabitant of others' successes until only those who can weaponise that longing remain loyal.",
      traits: [
        "Coveting Citadel: Base 7 DEF becomes 9 DEF inside populated hubs.",
